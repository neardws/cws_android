...
public class Result implements Serializable {
    ...
    public void fromJSON(JSONObject jsonObject){
        try {//那也就是说这里并没有
                ...
                this.setTimeStamp(jsonObject.getLong("timeStamp"));//timeStamp是平板1发送时间
//                this.setReceiverTimeStamp(jsonObject.getLong("receiverTimeStamp"));
            this.setReceiverTimeStamp(jsonObject.getLong("UDP_Receive_Time"));
//                this.setSendTimeStamp(jsonObject.getLong("sendTimeStamp"));
            this.setSendTimeStamp(jsonObject.getLong("UDP_Send_Time"));
